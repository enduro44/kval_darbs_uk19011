...
namespace Controllers
{
    public class SocketControllerC : MonoBehaviour
    {
        ...
        private void Entered(SelectEnterEventArgs args)
        {
            ...
            //GameObject boxWall = childObj.transform.GetChild(1).gameObject;
            //XRSocketInteractor targetSocket = boxWall.GetComponent<XRSocketInteractor>();

            //targetSocket.socketActive = false;
